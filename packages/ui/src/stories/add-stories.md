...
This document provides instructions for AI assistants when creating Storybook stories for Vue components in the `@erteam/ui` package.
...
Import icons from `@erteam/assets`:

```typescript
import { SearchIcon, ChevronDownIcon } from '@erteam/assets'
