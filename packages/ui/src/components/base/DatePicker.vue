...
import { CalendarIcon, XIcon } from '@erteam/assets'
import chevronLeftIcon from '@erteam/assets/icons/chevron-left.svg?raw'
import chevronRightIcon from '@erteam/assets/icons/chevron-right.svg?raw'
