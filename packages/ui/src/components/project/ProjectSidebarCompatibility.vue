...
import { FormattedTag, projectCompatibilityMessages, TagItem } from '@erteam/ui'
import type { GameVersionTag, PlatformTag } from '@erteam/utils'
import { getVersionsToDisplay } from '@erteam/utils'
