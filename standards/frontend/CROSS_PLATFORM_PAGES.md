...
import { provideContentManager, ContentPageLayout } from '@erteam/ui'
...
<script setup lang="ts">
import { ServersManageContentPage } from '@erteam/ui'
</script>
...
```ts
import { injectModrinthClient, injectModrinthServerContext, ServersManageFilesPage } from '@erteam/ui'
