...
import VersionSummary from '@erteam/ui/src/components/version/VersionSummary.vue'
import { capitalizeString, formatProjectType, renderString } from '@erteam/utils'
