...
<script setup>
import { ImageIcon, ScaleIcon, TrashIcon, TriangleAlertIcon, UploadIcon } from '@erteam/assets'
import { MIN_SUMMARY_CHARS } from '@erteam/moderation'
import {
	Avatar,
	ButtonStyled,
	Combobox,
...
import { fileIsValid, formatProjectStatus, formatProjectType } from '@erteam/utils'
