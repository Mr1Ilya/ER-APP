<template>
	<div class="markdown-body">
		...
		<p>
			...
			Please review the
			<nuxt-link to="/legal/cmp">Rewards Program Terms</nuxt-link>, as it contains very important
			language regarding, among other things, your status as an independent contractor, your
			responsibility to pay taxes, our disclaimers and limitations of liability (in addition to our
			disclaimers and limitations of liability in these Terms of Use).
		</p>
		...
		<p>
			...
			<a href="mailto:support@erteam.com">support@erteam.com</a>.
		</p>
	</div>
</template>
