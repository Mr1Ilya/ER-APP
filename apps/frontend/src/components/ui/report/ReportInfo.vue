...
<script setup>
import { ReportIcon, UnknownIcon, VersionIcon } from '@erteam/assets'
import { Avatar, Badge, CopyCode, useFormatDateTime, useRelativeTime } from '@erteam/ui'
import { formatProjectType, renderHighlightedString } from '@erteam/utils'
