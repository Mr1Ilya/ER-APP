...
import { ChevronDownIcon, MessageIcon, ReplyIcon, SendIcon } from '@erteam/assets'
import type { QuickReply } from '@erteam/moderation'
import {
	ButtonStyled,
	CopyCode,
...
import type { Thread, User } from '@erteam/utils'
