...
<script setup>
import { BoxIcon, SettingsIcon, TransferIcon, XIcon } from '@erteam/assets'
import { Avatar, ButtonStyled, Checkbox, CopyCode, Modal } from '@erteam/ui'
import { formatProjectType } from '@erteam/utils'
