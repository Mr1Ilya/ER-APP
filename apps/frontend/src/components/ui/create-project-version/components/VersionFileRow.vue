...
import { ArrowLeftRightIcon, CheckIcon, XIcon } from '@erteam/assets'
import { ButtonStyled, Combobox, injectProjectPageContext } from '@erteam/ui'
import type { ComboboxOption } from '@erteam/ui/src/components/base/Combobox.vue'
import { acceptFileFromProjectType } from '@erteam/utils'
