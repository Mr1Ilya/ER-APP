    ...
    with_test_environment(
        ...
        |test_env: TestEnvironment<ApiV3>| async move {
            sqlx::query!(
                ...
                VALUES
                    (1000, 'userland', 'userland@erteam.com', 'developer'),
                    (1001, 'useful', 'useful@erteam.com', 'developer'),
                    (1002, 'Useless', 'useless@erteam.com', 'developer')
                ",
            )
    ...
    with_test_environment(
        ...
        |test_env: TestEnvironment<ApiV3>| async move {
            ...
            sqlx::query!(
                "
                INSERT INTO users (id, username, email, role)
                VALUES (2100, 'prefix_under_score', 'prefix_under_score@erteam.com', 'developer')
                ",
            )
            .execute(&*test_env.db.pool)
            .await
