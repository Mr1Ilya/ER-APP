...
VALUES ({{user_id::ADMIN}},     'Admin',     'admin@erteam.com',     'admin'),
       ({{user_id::MODERATOR}}, 'Moderator', 'moderator@erteam.com', 'moderator'),
       ({{user_id::USER}},      'User',      'user@erteam.com',      'developer'),
       ({{user_id::FRIEND}},    'Friend',    'friend@erteam.com',    'developer'),
       ({{user_id::ENEMY}},     'Enemy',     'enemy@erteam.com',     'developer');
