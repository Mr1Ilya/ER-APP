...
import { MoreVerticalIcon, TrashIcon, UserIcon, XIcon } from '@erteam/assets'
import { Accordion, Avatar, ButtonStyled, defineMessages, OverflowMenu, useVIntl } from '@erteam/ui'
