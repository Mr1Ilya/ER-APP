...
// i18n symbols that should be imported from @erteam/ui
...
const VALID_IMPORT_SOURCES = ['@erteam/ui']
...
function main() {
	...
	if (verbose) {
		console.log(theme.muted('  Tip: Import these symbols from @erteam/ui'))
		console.log(theme.muted('  Example: import { useVIntl, defineMessages } from \'@erteam/ui\''))
		console.log()
	}
